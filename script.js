...
function merryChristmas () {
    ...
    heading.textContent = `Schöne Weihnachten!!! HO-HO-HO!`;
...
btn.addEventListener('click', () => {
    if (p === 0) {
        audioFile.play();
        p++;
        btnPic.src = 'https://img.icons8.com/dotty/80/000000/pause.png'
    }
    else {
        audioFile.pause();
        p--;
        btnPic.src = 'https://img.icons8.com/wired/64/000000/play.png'
    }
})
